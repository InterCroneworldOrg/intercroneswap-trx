  ...
  const handleCurrencyASelect = useCallback(
    (currencyA: Currency) => {
      ...
      if (newCurrencyIdA === currencyIdB) {
        history.push(versionedPath(`/add/${currencyIdB}/${currencyIdA}`));
      } else {
        history.push(versionedPath(`/add/${newCurrencyIdA}/${currencyIdB}`));
      }
    },
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        if (currencyIdB) {
          history.push(versionedPath(`/add/${currencyIdB}/${newCurrencyIdB}`));
        } else {
          history.push(versionedPath(`/add/${newCurrencyIdB}`));
        }
      } else {
        history.push(versionedPath(`/add/${currencyIdA ? currencyIdA : 'TRX'}/${newCurrencyIdB}`));
      }
    },
